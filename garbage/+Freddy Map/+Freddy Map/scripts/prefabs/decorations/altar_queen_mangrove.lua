...
local function MakeAltarQueen(name, data)
    local assets =
    {
	    Asset("ANIM", "anim/altar_queen_mangrove.zip"),
    }
    local function fn()
        ...
        inst.AnimState:SetBank(data.bank or "altar_queen_mangrove")
        inst.AnimState:SetBuild(data.build or "altar_queen_mangrove")
...
return MakeAltarQueen("altar_queen_mangrove", {scale = 1, blockrad = 3})

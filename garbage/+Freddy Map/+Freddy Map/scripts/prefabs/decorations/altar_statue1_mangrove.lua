...
local function MakeAltarStatue(name, data)
    local assets =
    {
	    Asset("ANIM", "anim/altar_statue1_mangrove.zip"),
    }
    local function fn()
        ...
        inst.AnimState:SetBank(data.bank or "altar_statue1_mangrove")
        inst.AnimState:SetBuild(data.build or "altar_statue1_mangrove")
...
return MakeAltarStatue("altar_statue1_mangrove", {scale = 1, blockrad = 3})

...
local function MakeOceantreePillar(name, data)
    local assets =
    {
    ...
    local function fn()
        ...
        inst.AnimState:SetBank(data.bank or "oceantree_pillar")
        inst.AnimState:SetBuild(data.build or "oceantree_pillar_build1")
...
return MakeOceantreePillar("oceantree_pillar_mangrove", {scale = 1, blockrad = 1})
...
local function MakeDriftwood(name, data)
    local assets =
    {
	    Asset("ANIM", "anim/driftwood_mangrove.zip"),
    }
    local function fn()
        ...
        inst.AnimState:SetBank(data.bank or "driftwood_mangrove")
        inst.AnimState:SetBuild(data.build or "driftwood_mangrove")
...
return MakeDriftwood("driftwood_mangrove", {scale = 1, blockrad = 3})

local assets =
{
    Asset("ANIM", "anim/mangrove_portal.zip"),
}
...
local function CreateDropShadow(parent)
    ...
    inst.AnimState:SetBuild("mangrove_portal")
    inst.AnimState:SetBank("mangrove_portal")
    inst.AnimState:PlayAnimation("idle", true)
    inst.AnimState:SetOrientation(ANIM_ORIENTATION.OnGround)
    inst.AnimState:SetLayer(LAYER_BACKGROUND)
    inst.AnimState:SetSortOrder(1)
    inst.AnimState:OverrideSymbol("lavaarena_portal01", "mangrove_portal", "shadow")
...
return Prefab("mangrove_portal", fn, assets, prefabs),
